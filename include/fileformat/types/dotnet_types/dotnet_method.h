/**
 * @file include/fileformat/types/dotnet_types/dotnet_method.h
 * @brief Class for .NET method.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_METHOD_H
#define FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_METHOD_H

#include <memory>

#include "fileformat/types/dotnet_types/dotnet_data_types.h"
#include "fileformat/types/dotnet_types/dotnet_parameter.h"
