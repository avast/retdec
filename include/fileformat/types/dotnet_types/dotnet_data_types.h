/**
 * @file include/fileformat/types/dotnet_types/dotnet_data_types.h
 * @brief Classes for .NET data types.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_DATA_TYPES_H
#define FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_DATA_TYPES_H
...
class DotnetDataType : public DotnetDataTypeBase
{
	public:
		...
		{
			static const std::unordered_map<ElementType, std::string, tl_cpputils::EnumClassKeyHash> typeNames =
			{
