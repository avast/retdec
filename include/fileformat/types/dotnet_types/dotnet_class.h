/**
 * @file include/fileformat/types/dotnet_types/dotnet_class.h
 * @brief Class for .NET class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_CLASS_H
#define FILEFORMAT_TYPES_DOTNET_TYPES_DOTNET_CLASS_H

#include <memory>
#include <vector>

#include "fileformat/types/dotnet_types/dotnet_field.h"
#include "fileformat/types/dotnet_types/dotnet_method.h"
