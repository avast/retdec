/**
 * @file include/fileformat/types/strings/character_iterator.h
 * @brief Class for character iterator.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_STRINGS_CHARACTER_ITERATOR_H
#define FILEFORMAT_TYPES_STRINGS_CHARACTER_ITERATOR_H
