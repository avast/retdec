/**
 * @file include/fileformat/types/relocation_table/relocation.h
 * @brief Class for one relocation.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_RELOCATION_TABLE_RELOCATION_H
#define FILEFORMAT_TYPES_RELOCATION_TABLE_RELOCATION_H
