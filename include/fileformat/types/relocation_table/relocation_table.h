/**
 * @file include/fileformat/types/relocation_table/relocation_table.h
 * @brief Class for relocation table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_RELOCATION_TABLE_RELOCATION_TABLE_H
#define FILEFORMAT_TYPES_RELOCATION_TABLE_RELOCATION_TABLE_H

#include <vector>

#include "fileformat/types/relocation_table/relocation.h"
