/**
 * @file include/fileformat/types/import_table/import_table.h
 * @brief Class for import table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_IMPORT_TABLE_IMPORT_TABLE_H
#define FILEFORMAT_TYPES_IMPORT_TABLE_IMPORT_TABLE_H
