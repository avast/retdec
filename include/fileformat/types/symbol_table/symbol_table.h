/**
 * @file include/fileformat/types/symbol_table/symbol_table.h
 * @brief Class for symbol table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_SYMBOL_TABLE_SYMBOL_TABLE_H
#define FILEFORMAT_TYPES_SYMBOL_TABLE_SYMBOL_TABLE_H
