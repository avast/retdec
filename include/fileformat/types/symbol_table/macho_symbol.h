/**
 * @file include/fileformat/types/symbol_table/macho_symbol.h
 * @brief Class for one Mach-O symbol.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_SYMBOL_TABLE_MACHO_SYMBOL_H
#define FILEFORMAT_TYPES_SYMBOL_TABLE_MACHO_SYMBOL_H
