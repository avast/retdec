/**
 * @file include/fileformat/types/rich_header/rich_header.h
 * @brief Class for rich header.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_RICH_HEADER_RICH_HEADER_H
#define FILEFORMAT_TYPES_RICH_HEADER_RICH_HEADER_H

#include <string>
#include <vector>

#include "fileformat/types/rich_header/linker_info.h"
