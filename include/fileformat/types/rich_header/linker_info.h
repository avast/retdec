/**
 * @file include/fileformat/types/rich_header/linker_info.h
 * @brief Class for information about linker.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_RICH_HEADER_LINKER_INFO_H
#define FILEFORMAT_TYPES_RICH_HEADER_LINKER_INFO_H
