/**
 * @file include/fileformat/types/resource_table/resource_table.h
 * @brief Class for resource table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_RESOURCE_TABLE_RESOURCE_TABLE_H
#define FILEFORMAT_TYPES_RESOURCE_TABLE_RESOURCE_TABLE_H

#include <vector>

#include "fileformat/types/resource_table/resource.h"
