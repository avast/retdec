/**
 * @file include/fileformat/types/dotnet_headers/blob_stream.h
 * @brief Class for \#Blob Stream.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DOTNET_HEADERS_BLOB_STREAM_H
#define FILEFORMAT_TYPES_DOTNET_HEADERS_BLOB_STREAM_H
