/**
 * @file include/fileformat/types/dotnet_headers/metadata_tables.h
 * @brief Classes for metadata tables.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DOTNET_HEADERS_METADATA_TABLES_H
#define FILEFORMAT_TYPES_DOTNET_HEADERS_METADATA_TABLES_H
