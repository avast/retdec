/**
 * @file include/fileformat/types/dynamic_table/dynamic_entry.h
 * @brief Class for dynamic entry.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DYNAMIC_TABLE_DYNAMIC_ENTRY_H
#define FILEFORMAT_TYPES_DYNAMIC_TABLE_DYNAMIC_ENTRY_H
