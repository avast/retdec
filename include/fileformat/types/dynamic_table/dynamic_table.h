/**
 * @file include/fileformat/types/dynamic_table/dynamic_table.h
 * @brief Class for dynamic table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_DYNAMIC_TABLE_DYNAMIC_TABLE_H
#define FILEFORMAT_TYPES_DYNAMIC_TABLE_DYNAMIC_TABLE_H
