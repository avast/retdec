/**
 * @file include/fileformat/types/certificate_table/certificate_table.h
 * @brief Class for certificate table.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_CERTIFICATE_TABLE_CERTIFICATE_TABLE_H
#define FILEFORMAT_TYPES_CERTIFICATE_TABLE_CERTIFICATE_TABLE_H
