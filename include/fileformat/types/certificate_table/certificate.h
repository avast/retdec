/**
 * @file include/fileformat/types/certificate_table/certificate.h
 * @brief Class for one certificate.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_TYPES_CERTIFICATE_TABLE_CERTIFICATE_H
#define FILEFORMAT_TYPES_CERTIFICATE_TABLE_CERTIFICATE_H
