/**
 * @file include/fileformat/file_format/macho/macho_format.h
 * @brief Definition of MachOFormat class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_MACHO_MACHO_FORMAT_H
#define FILEFORMAT_FILE_FORMAT_MACHO_MACHO_FORMAT_H
