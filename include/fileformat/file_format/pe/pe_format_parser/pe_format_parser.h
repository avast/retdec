/**
 * @file include/fileformat/file_format/pe/pe_format_parser/pe_format_parser.h
 * @brief Definition of PeFormatParser class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_PE_PE_FORMAT_PARSER_PE_FORMAT_PARSER_H
#define FILEFORMAT_FILE_FORMAT_PE_PE_FORMAT_PARSER_PE_FORMAT_PARSER_H
...
class PeFormatParser
{
	...
	public:
		...
		virtual tl_cpputils::RangeContainer<std::uint64_t> getImportDirectoryOccupiedAddresses() const = 0;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getExportDirectoryOccupiedAddresses() const = 0;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getDebugDirectoryOccupiedAddresses() const = 0;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getResourceDirectoryOccupiedAddresses() const = 0;
		/// @}
};
