/**
 * @file include/fileformat/file_format/pe/pe_format_parser/pe_format_parser32.h
 * @brief Definition of PeFormatParser32 class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_PE_PE_FORMAT_PARSER_PE_FORMAT_PARSER32_H
#define FILEFORMAT_FILE_FORMAT_PE_PE_FORMAT_PARSER_PE_FORMAT_PARSER32_H
...
{
	private:
		PeLib::PeFileT<32> *peFile;     ///< 32-bit PE file
	...
	public:
		...
		virtual tl_cpputils::RangeContainer<std::uint64_t> getImportDirectoryOccupiedAddresses() const override;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getExportDirectoryOccupiedAddresses() const override;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getDebugDirectoryOccupiedAddresses() const override;
		virtual tl_cpputils::RangeContainer<std::uint64_t> getResourceDirectoryOccupiedAddresses() const override;
		/// @}
};
