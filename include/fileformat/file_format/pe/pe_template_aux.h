/**
 * @file include/fileformat/file_format/pe/pe_template_aux.h
 * @brief Auxiliary functions for PE files.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_PE_PE_TEMPLATE_AUX_H
#define FILEFORMAT_FILE_FORMAT_PE_PE_TEMPLATE_AUX_H
