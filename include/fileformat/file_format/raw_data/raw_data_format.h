/**
 * @file include/fileformat/file_format/raw_data/raw_data_format.h
 * @brief Definition of RawDataFormat class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_RAW_DATA_RAW_DATA_FORMAT_H
#define FILEFORMAT_FILE_FORMAT_RAW_DATA_RAW_DATA_FORMAT_H
...
class RawDataFormat : public FileFormat
{
	private:
		...
		tl_cpputils::Endianness endianness = tl_cpputils::Endianness::LITTLE;
	...
	public:
		...
		void setEntryPoint(tl_cpputils::Address entryPoint);
		void setBaseAddress(tl_cpputils::Address baseAddress);
		/// @}
