/**
 * @file include/fileformat/file_format/intel_hex/intel_hex_parser/intel_hex_tokenizer.h
 * @brief Definition of IntelHexToken and IntelHexTokenizer classes.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_PARSER_INTEL_HEX_TOKENIZER_H
#define FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_PARSER_INTEL_HEX_TOKENIZER_H
