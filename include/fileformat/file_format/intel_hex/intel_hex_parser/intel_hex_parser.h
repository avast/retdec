/**
 * @file include/fileformat/file_format/intel_hex/intel_hex_parser/intel_hex_parser.h
 * @brief Definition of IntelHexSection and IntelHexParser classes.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_PARSER_INTEL_HEX_PARSER_H
#define FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_PARSER_INTEL_HEX_PARSER_H
...
class IntelHexParser
{
	private:
		...
		tl_cpputils::Address actualAddress; ///< Address of last byte saved to actual section
