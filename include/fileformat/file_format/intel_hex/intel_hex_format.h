/**
 * @file include/fileformat/file_format/intel_hex/intel_hex_format.h
 * @brief Definition of IntelHexFormat class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_FORMAT_H
#define FILEFORMAT_FILE_FORMAT_INTEL_HEX_INTEL_HEX_FORMAT_H
...
class IntelHexFormat : public FileFormat
{
	private:
		...
		tl_cpputils::Endianness endianness = tl_cpputils::Endianness::UNKNOWN; ///< Intel HEX provides no information about endianness
		std::size_t bytesPerWord = 0;                                                ///< Intel HEX provides no information about word size
		tl_cpputils::Address epOffset = 0;                                        ///< offset of entry point
	...
	public:
		...
		void setEndianness(tl_cpputils::Endianness e);
