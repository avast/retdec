/**
 * @file include/fileformat/file_format/coff/coff_format.h
 * @brief Definition of CoffFormat class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEFORMAT_FILE_FORMAT_COFF_COFF_FORMAT_H
#define FILEFORMAT_FILE_FORMAT_COFF_COFF_FORMAT_H
