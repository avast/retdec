...
class AddressRangeJson : public tl_cpputils::AddressRange
{
	public:
		AddressRangeJson() : AddressRange() {}
		AddressRangeJson(tl_cpputils::Address f, tl_cpputils::Address s) : AddressRange(f, s) {}
...
class BaseAssociativeContainer
{
	...
	public:
		...
		{
			return tl_cpputils::likeConstVersion(
