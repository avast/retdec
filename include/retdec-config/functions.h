...
using LineNumber = tl_cpputils::Address;
 ...
 */
class Function : public tl_cpputils::AddressRange
{
	public:
		...
		void setStartLine(const tl_cpputils::Address& l);
		void setEndLine(const tl_cpputils::Address& l);
...
class FunctionContainer : public BaseAssociativeContainer<std::string, Function>
{
	public:
		...
		Function* getFunctionByStartAddress(const tl_cpputils::Address& addr);
