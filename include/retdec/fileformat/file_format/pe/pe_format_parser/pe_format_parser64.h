...
class PeFormatParser64 : public PeFormatParser
{
	...
	public:
		...
		virtual unsigned long long getTlsEndAddressOfRawData() const;
		virtual unsigned long long getTlsAddressOfIndex() const;
		virtual unsigned long long getTlsAddressOfCallBacks() const;
		virtual unsigned long long getTlsSizeOfZeroFill() const;
		virtual unsigned long long getTlsCharacteristics() const;
