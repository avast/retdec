/**
 * @file retdec/include/bin2llvmir/providers/calling_convention/arm.h
 * @brief Calling conventions of ARM architecture.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef RETDEC_BIN2LLVMIR_PROVIDERS_CALL_CONV_ARM_H
#define RETDEC_BIN2LLVMIR_PROVIDERS_CALL_CONV_ARM_H
