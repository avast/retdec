...
#ifndef RETDEC_BIN2LLVMIR_PROVIDERS_ABI_PASCAL_X86_H
#define RETDEC_BIN2LLVMIR_PROVIDERS_ABI_PASCAL_X86_H
...
class AbiX86Pascal : public Abi
{
	// Ctors, dtors.
	//
	public:
		AbiX86Pascal(llvm::Module* m, Config* c);
		virtual ~AbiX86Pascal();
