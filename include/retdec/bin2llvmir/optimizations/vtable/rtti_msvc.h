/**
 * @file include/retdec/bin2llvmir/optimizations/vtable/rtti_msvc.h
...
#ifndef RETDEC_BIN2LLVMIR_OPTIMIZATIONS_VTABLE_RTTI_MSVC_H
#define RETDEC_BIN2LLVMIR_OPTIMIZATIONS_VTABLE_RTTI_MSVC_H
