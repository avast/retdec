/**
 * @file include/retdec/cpdetec/signatures/yara/database/database.h
 * @brief Database of signatures.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef RETDEC_CPDETECT_SIGNATURES_YARA_DATABASE_DATABASE_H
#define RETDEC_CPDETECT_SIGNATURES_YARA_DATABASE_DATABASE_H
