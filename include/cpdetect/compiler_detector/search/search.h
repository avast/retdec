/**
 * @file include/cpdetec/compiler_detector/search/search.h
 * @brief Class for search in file.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef CPDETECT_COMPILER_DETECTOR_SEARCH_SEARCH_H
#define CPDETECT_COMPILER_DETECTOR_SEARCH_SEARCH_H
