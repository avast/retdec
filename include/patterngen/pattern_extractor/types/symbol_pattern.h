/**
 * @file include/patterngen/pattern_extractor/types/symbol_pattern.h
 * @brief Class representing pattern of one function.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef PATTERNGEN_PATTERN_EXTRACTOR_TYPES_SYMBOL_PATTERN_H
#define PATTERNGEN_PATTERN_EXTRACTOR_TYPES_SYMBOL_PATTERN_H
