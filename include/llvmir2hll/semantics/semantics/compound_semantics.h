/**
* @file include/llvmir2hll/semantics/semantics/compound_semantics.h
* @brief A class providing compound semantics from several different
*        semantics.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_SEMANTICS_SEMANTICS_COMPOUND_SEMANTICS_H
#define LLVMIR2HLL_SEMANTICS_SEMANTICS_COMPOUND_SEMANTICS_H
