/**
* @file include/llvmir2hll/evaluator/arithm_expr_evaluators/c_arithm_expr_evaluator.h
* @brief Evaluates expressions with c language conditions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATORS_C_ARITHM_EXPR_EVALUATOR_H
#define LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATORS_C_ARITHM_EXPR_EVALUATOR_H
