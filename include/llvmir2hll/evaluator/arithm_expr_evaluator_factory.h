/**
* @file include/llvmir2hll/evaluator/arithm_expr_evaluator_factory.h
* @brief Factory that creates instances of classes derived from
*        ArithmExprEvaluator.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATOR_FACTORY_H
#define LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATOR_FACTORY_H
