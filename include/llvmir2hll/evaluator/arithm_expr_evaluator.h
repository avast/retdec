/**
* @file include/llvmir2hll/evaluator/arithm_expr_evaluator.h
* @brief A base class for all evaluators.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATOR_H
#define LLVMIR2HLL_EVALUATOR_ARITHM_EXPR_EVALUATOR_H
