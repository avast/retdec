/**
* @file include/llvmir2hll/pattern/pattern_finders/api_call_seq_pattern_finder.h
* @brief Finds sequences of interesting API calls in a module.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_SEQ_PATTERN_FINDER_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_SEQ_PATTERN_FINDER_H
