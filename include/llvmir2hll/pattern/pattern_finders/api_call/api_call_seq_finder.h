/**
* @file include/llvmir2hll/pattern/pattern_finders/api_call/api_call_seq_finder.h
* @brief A base class for all API calls finders.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_FINDER_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_FINDER_H
...
*/
class APICallSeqFinder: private tl_cpputils::NonCopyable {
public:
	/// List of patterns.
