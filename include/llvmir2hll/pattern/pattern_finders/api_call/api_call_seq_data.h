/**
* @file include/llvmir2hll/pattern/pattern_finders/api_call/api_call_seq_data.h
* @brief A storage of intermediate data when finding sequences of API calls.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_DATA_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_DATA_H
