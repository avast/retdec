/**
* @file include/llvmir2hll/pattern/pattern_finders/api_call/api_call_seq_finders/basic_block_api_call_seq_finder.h
* @brief API call finder which searches only in a basic block.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_FINDERS_BASIC_BLOCK_API_CALL_SEQ_FINDER_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_SEQ_FINDERS_BASIC_BLOCK_API_CALL_SEQ_FINDER_H
