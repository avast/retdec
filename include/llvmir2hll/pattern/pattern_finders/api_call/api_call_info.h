/**
* @file include/llvmir2hll/pattern/pattern_finders/api_call/api_call_info.h
* @brief A representation of information about an API call.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_INFO_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDERS_API_CALL_API_CALL_INFO_H
