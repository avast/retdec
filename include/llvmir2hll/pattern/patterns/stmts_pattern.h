/**
* @file include/llvmir2hll/pattern/patterns/stmts_pattern.h
* @brief A pattern that is composed of zero or more statements.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERNS_STMTS_PATTERN_H
#define LLVMIR2HLL_PATTERN_PATTERNS_STMTS_PATTERN_H
