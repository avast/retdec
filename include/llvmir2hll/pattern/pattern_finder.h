/**
* @file include/llvmir2hll/pattern/pattern_finder.h
* @brief A base class for all pattern finders.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_PATTERN_PATTERN_FINDER_H
#define LLVMIR2HLL_PATTERN_PATTERN_FINDER_H
...
*/
class PatternFinder: private tl_cpputils::NonCopyable {
public:
	/// A list of patterns.
