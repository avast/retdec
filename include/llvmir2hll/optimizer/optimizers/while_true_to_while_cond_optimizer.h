/**
* @file include/llvmir2hll/optimizer/optimizers/while_true_to_while_cond_optimizer.h
* @brief Optimizes "while true" loops into "while cond" loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_WHILE_TRUE_TO_WHILE_COND_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_WHILE_TRUE_TO_WHILE_COND_OPTIMIZER_H
