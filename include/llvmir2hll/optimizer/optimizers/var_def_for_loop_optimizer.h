/**
* @file include/llvmir2hll/optimizer/optimizers/var_def_for_loop_optimizer.h
* @brief Optimizes VarDefStmts for induction variables of for loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VAR_DEF_FOR_LOOP_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VAR_DEF_FOR_LOOP_OPTIMIZER_H
