/**
* @file include/llvmir2hll/optimizer/optimizers/simple_copy_propagation_optimizer.h
* @brief A simple version of the copy propagation optimization.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_SIMPLE_COPY_PROPAGATION_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_SIMPLE_COPY_PROPAGATION_OPTIMIZER_H
