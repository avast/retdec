/**
* @file include/llvmir2hll/optimizer/optimizers/loop_last_continue_optimizer.h
* @brief Optimizes redundant continue statements in loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_LOOP_LAST_CONTINUE_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_LOOP_LAST_CONTINUE_OPTIMIZER_H
