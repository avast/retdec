/**
* @file include/llvmir2hll/optimizer/optimizers/pre_while_true_loop_conv_optimizer.h
* @brief Optimizes the bodies of @c while @c True loops to simplify
*        other optimizations of these loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_PRE_WHILE_TRUE_LOOP_CONV_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_PRE_WHILE_TRUE_LOOP_CONV_OPTIMIZER_H
