/**
* @file include/llvmir2hll/optimizer/optimizers/empty_array_to_string_optimizer.h
* @brief Optimizes global empty arrays to empty strings.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_EMPTY_ARRAY_TO_STRING_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_EMPTY_ARRAY_TO_STRING_OPTIMIZER_H
