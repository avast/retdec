/**
* @file include/llvmir2hll/optimizer/optimizers/empty_stmt_optimizer.h
* @brief Removes empty statements.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_EMPTY_STMT_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_EMPTY_STMT_OPTIMIZER_H
