/**
* @file include/llvmir2hll/optimizer/optimizers/dead_code_optimizer.h
* @brief Removes dead code.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_DEAD_CODE_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_DEAD_CODE_OPTIMIZER_H
