/**
* @file include/llvmir2hll/optimizer/optimizers/void_return_optimizer.h
* @brief Optimizes redundant void returns.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VOID_RETURN_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VOID_RETURN_OPTIMIZER_H
