/**
* @file include/llvmir2hll/optimizer/optimizers/deref_to_array_index_optimizer.h
* @brief Optimizes pointer arithmetic on variables or array accesses or
*        structures to array accesses.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_DEREF_TO_ARRAY_INDEX_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_DEREF_TO_ARRAY_INDEX_OPTIMIZER_H
