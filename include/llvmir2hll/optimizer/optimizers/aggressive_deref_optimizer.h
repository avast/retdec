/**
* @file include/llvmir2hll/optimizer/optimizers/aggressive_deref_optimizer.h
* @brief Optimizes dereferences of integer values.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_AGGRESSIVE_DEREF_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_AGGRESSIVE_DEREF_OPTIMIZER_H
