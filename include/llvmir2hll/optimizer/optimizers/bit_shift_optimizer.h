/**
* @file include/llvmir2hll/optimizer/optimizers/bit_shift_optimizer.h
* @brief Change bit shift to division or multiplication.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BIT_SHIFT_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BIT_SHIFT_OPTIMIZER_H
