/**
* @file include/llvmir2hll/optimizer/optimizers/aggressive_global_to_local_optimizer.h
* @brief Converts all global variables without a name from debug information
*        to local variables.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_AGGRESSIVE_GLOBAL_TO_LOCAL_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_AGGRESSIVE_GLOBAL_TO_LOCAL_OPTIMIZER_H
