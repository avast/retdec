/**
* @file include/llvmir2hll/optimizer/optimizers/if_before_loop_optimizer.h
* @brief Optimizes if statements before loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_IF_BEFORE_LOOP_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_IF_BEFORE_LOOP_OPTIMIZER_H
