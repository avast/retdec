/**
* @file include/llvmir2hll/optimizer/optimizers/simplify_arithm_expr/bool_comparison_optimizer.h
* @brief Simplification of comparisons with @c true and @c false.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_SIMPLIFY_ARITHM_EXPR_BOOL_COMPARISON_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_SIMPLIFY_ARITHM_EXPR_BOOL_COMPARISON_OPTIMIZER_H
