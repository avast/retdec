/**
* @file include/llvmir2hll/optimizer/optimizers/break_continue_return_optimizer.h
* @brief Removes statements following a break, continue, or return statements.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BREAK_CONTINUE_RETURN_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BREAK_CONTINUE_RETURN_OPTIMIZER_H
