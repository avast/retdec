/**
* @file include/llvmir2hll/optimizer/optimizers/remove_all_casts_optimizer.h
* @brief Removes all casts from a module.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_REMOVE_ALL_CASTS_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_REMOVE_ALL_CASTS_OPTIMIZER_H
