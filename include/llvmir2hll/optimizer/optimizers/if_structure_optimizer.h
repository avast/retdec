/**
* @file include/llvmir2hll/optimizer/optimizers/if_structure_optimizer.h
* @brief Optimizes the structure of if statements.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_IF_STRUCTURE_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_IF_STRUCTURE_OPTIMIZER_H
