/**
* @file include/llvmir2hll/optimizer/optimizers/llvm_intrinsics_optimizer.h
* @brief Optimizes calls to LLVM intrinsic functions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_LLVM_INTRINSICS_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_LLVM_INTRINSICS_OPTIMIZER_H
