/**
* @file include/llvmir2hll/optimizer/optimizers/c_array_arg_optimizer.h
* @brief Optimizes array arguments of function calls.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_C_ARRAY_ARG_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_C_ARRAY_ARG_OPTIMIZER_H
