/**
* @file include/llvmir2hll/optimizer/optimizers/c_cast_optimizer.h
* @brief Removes useless casts when emitting C code.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_C_CAST_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_C_CAST_OPTIMIZER_H
