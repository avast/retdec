/**
* @file include/llvmir2hll/optimizer/optimizers/bit_op_to_log_op_optimizer.h
* @brief Optimizes BitAndExpr to AndOpExpr or BitOrExpr to OrOpExpr if fulfil
*        conditions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BIT_OP_TO_LOG_OP_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_BIT_OP_TO_LOG_OP_OPTIMIZER_H
