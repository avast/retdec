/**
* @file include/llvmir2hll/optimizer/optimizers/while_true_to_for_loop_optimizer.h
* @brief Optimizes while loops into for loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_WHILE_TRUE_TO_FOR_LOOP_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_WHILE_TRUE_TO_FOR_LOOP_OPTIMIZER_H
