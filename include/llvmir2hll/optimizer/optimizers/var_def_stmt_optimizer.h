/**
* @file include/llvmir2hll/optimizer/optimizers/var_def_stmt_optimizer.h
* @brief Optimizes VarDefStmt to the closest place of it's variable use.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VAR_DEF_STMT_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZERS_VAR_DEF_STMT_OPTIMIZER_H
