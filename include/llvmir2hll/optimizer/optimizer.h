/**
* @file include/llvmir2hll/optimizer/optimizer.h
* @brief A base class of all optimizers.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OPTIMIZER_OPTIMIZER_H
#define LLVMIR2HLL_OPTIMIZER_OPTIMIZER_H
...
*/
class Optimizer: public OrderedAllVisitor, private tl_cpputils::NonCopyable {
public:
