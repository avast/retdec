/**
* @file include/llvmir2hll/ir/value.h
* @brief A base class of all objects a module can contain.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_IR_VALUE_H
#define LLVMIR2HLL_IR_VALUE_H
...
#include "llvmir2hll/support/metadatable.h"
#include "llvmir2hll/support/observer.h"
#include "llvmir2hll/support/smart_ptr.h"
#include "llvmir2hll/support/subject.h"
#include "llvmir2hll/support/visitable.h"
...
class Value: public Visitable, public Metadatable<std::string>,
		...
		public Subject<Value>, private tl_cpputils::NonCopyable {
public:
	virtual ~Value() = 0;
