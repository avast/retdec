/**
* @file include/llvmir2hll/ir/ptr_to_int_cast_expr.h
* @brief The casting of LLVM instruction PtrToInt.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_IR_PTR_TO_INT_CAST_EXPR_H
#define LLVMIR2HLL_IR_PTR_TO_INT_CAST_EXPR_H
...
public:
	...
	virtual ~PtrToIntCastExpr() override;
