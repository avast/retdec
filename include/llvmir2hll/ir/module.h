/**
* @file include/llvmir2hll/ir/module.h
* @brief A representation of a complete module.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_IR_MODULE_H
#define LLVMIR2HLL_IR_MODULE_H
...
#include "tl-cpputils/filter_iterator.h"
...
*/
class Module final: private tl_cpputils::NonCopyable {
public:
	...
	using func_filter_iterator = tl_cpputils::FilterIterator<func_iterator>;
