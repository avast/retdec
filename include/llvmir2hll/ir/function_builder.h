/**
* @file include/llvmir2hll/ir/function_builder.h
* @brief A builder providing a simple way of creating functions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_IR_FUNCTION_BUILDER_H
#define LLVMIR2HLL_IR_FUNCTION_BUILDER_H
...
*/
class FunctionBuilder: private tl_cpputils::NonCopyable {
public:
