/**
* @file include/llvmir2hll/ir/const_string.h
* @brief A generic string constant.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_IR_CONST_STRING_H
#define LLVMIR2HLL_IR_CONST_STRING_H
...
public:
	...
	using UnderlyingCharType = tl_cpputils::WideCharType;

	/// Underlying string type.
	using UnderlyingStringType = tl_cpputils::WideStringType;
