/**
* @file include/llvmir2hll/hll/bracket_managers/no_bracket_manager.h
* @brief A brackets manager that turns off eleminating redundant brackets.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_HLL_BRACKET_MANAGERS_NO_BRACKET_MANAGER_H
#define LLVMIR2HLL_HLL_BRACKET_MANAGERS_NO_BRACKET_MANAGER_H
