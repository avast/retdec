/**
* @file include/llvmir2hll/hll/hll_writer.h
* @brief A base class of all HLL writers.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_HLL_HLL_WRITER_H
#define LLVMIR2HLL_HLL_HLL_WRITER_H
...
*/
class HLLWriter: public Visitor, private tl_cpputils::NonCopyable {
public:
