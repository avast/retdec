/**
* @file include/llvmir2hll/hll/compound_op_managers/py_compound_op_manager.h
* @brief A compound operator manager for the Python' language.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_HLL_COMPOUND_OP_MANAGERS_PY_COMPOUND_OP_MANAGER_H
#define LLVMIR2HLL_HLL_COMPOUND_OP_MANAGERS_PY_COMPOUND_OP_MANAGER_H
