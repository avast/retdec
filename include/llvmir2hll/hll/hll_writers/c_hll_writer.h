/**
* @file include/llvmir2hll/hll/hll_writers/c_hll_writer.h
* @brief Implementation of the HLL writer for the C language.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_HLL_HLL_WRITERS_C_HLL_WRITER_H
#define LLVMIR2HLL_HLL_HLL_WRITERS_C_HLL_WRITER_H
