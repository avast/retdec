/**
* @file include/llvmir2hll/hll/hll_writers/py_hll_writer.h
* @brief A HLL writer for the Python' language.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_HLL_HLL_WRITERS_PY_HLL_WRITER_H
#define LLVMIR2HLL_HLL_HLL_WRITERS_PY_HLL_WRITER_H
