/**
* @file include/llvmir2hll/analysis/def_use_analysis.h
* @brief An analysis providing def-use chains.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_ANALYSIS_DEF_USE_ANALYSIS_H
#define LLVMIR2HLL_ANALYSIS_DEF_USE_ANALYSIS_H
...
*/
class DefUseAnalysis: private tl_cpputils::NonCopyable {
public:
