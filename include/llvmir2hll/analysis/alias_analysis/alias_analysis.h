/**
* @file include/llvmir2hll/analysis/alias_analysis/alias_analysis.h
* @brief A base class for all alias analyses.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_ANALYSIS_ALIAS_ANALYSIS_ALIAS_ANALYSIS_H
#define LLVMIR2HLL_ANALYSIS_ALIAS_ANALYSIS_ALIAS_ANALYSIS_H
...
*/
class AliasAnalysis: private tl_cpputils::NonCopyable {
public:
