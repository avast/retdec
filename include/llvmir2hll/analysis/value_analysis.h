/**
* @file include/llvmir2hll/analysis/value_analysis.h
* @brief An analysis for obtaining information about a value.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_ANALYSIS_VALUE_ANALYSIS_H
#define LLVMIR2HLL_ANALYSIS_VALUE_ANALYSIS_H

#include <cstddef>
#include <map>

#include "llvmir2hll/support/caching.h"
...
class ValueAnalysis: private OrderedAllVisitor,
	private tl_cpputils::NonCopyable, public ValidState,
