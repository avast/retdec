/**
* @file include/llvmir2hll/analysis/expr_types_analysis.h
* @brief A visitor for fixing the types in BIR.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_ANALYSIS_EXPR_TYPES_ANALYSIS_H
#define LLVMIR2HLL_ANALYSIS_EXPR_TYPES_ANALYSIS_H
