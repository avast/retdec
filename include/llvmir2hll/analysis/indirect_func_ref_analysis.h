/**
* @file include/llvmir2hll/analysis/indirect_func_ref_analysis.h
* @brief Analysis of functions that are referenced outside of direct calls.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_ANALYSIS_INDIRECT_FUNC_REF_ANALYSIS_H
#define LLVMIR2HLL_ANALYSIS_INDIRECT_FUNC_REF_ANALYSIS_H
