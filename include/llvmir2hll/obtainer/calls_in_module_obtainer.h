/**
* @file include/llvmir2hll/obtainer/calls_in_module_obtainer.h
* @brief An obtainer of information about function calls in a module.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OBTAINER_CALLS_IN_MODULE_OBTAINER_H
#define LLVMIR2HLL_OBTAINER_CALLS_IN_MODULE_OBTAINER_H
