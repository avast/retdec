/**
* @file include/llvmir2hll/obtainer/call_info_obtainers/pessim_call_info_obtainer.h
* @brief Obtainer of information about functions and function calls that
*        assumes nothing.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OBTAINER_CALL_INFO_OBTAINERS_PESSIM_CALL_INFO_OBTAINER_H
#define LLVMIR2HLL_OBTAINER_CALL_INFO_OBTAINERS_PESSIM_CALL_INFO_OBTAINER_H
