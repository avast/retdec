/**
* @file include/llvmir2hll/obtainer/call_info_obtainer.h
* @brief A base class of all obtainers of information about functions and
*        function calls.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_OBTAINER_CALL_INFO_OBTAINER_H
#define LLVMIR2HLL_OBTAINER_CALL_INFO_OBTAINER_H
...
*/
class CallInfo: private tl_cpputils::NonCopyable {
...
* Instances of this class have reference object semantics.
*/
class FuncInfo: private tl_cpputils::NonCopyable {
	friend class CallInfoObtainer;
...
private:
	...
	* Instances of this class have reference object semantics.
	*/
	class SCCComputer: private tl_cpputils::NonCopyable {
	public:
		~SCCComputer();
