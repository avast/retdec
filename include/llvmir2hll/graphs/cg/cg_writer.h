/**
* @file include/llvmir2hll/graphs/cg/cg_writer.h
* @brief A base class of all call graph (CG) writers.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CG_CG_WRITER_H
#define LLVMIR2HLL_GRAPHS_CG_CG_WRITER_H
...
*/
class CGWriter: private tl_cpputils::NonCopyable {
public:
	virtual ~CGWriter() = 0;
