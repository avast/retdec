/**
* @file include/llvmir2hll/graphs/cfg/cfg.h
* @brief A representation of a control-flow graph (CFG).
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CFG_CFG_H
#define LLVMIR2HLL_GRAPHS_CFG_CFG_H
...
*/
class CFG final: private tl_cpputils::NonCopyable {
...
public:
	...
	* Instances of this class have reference object semantics.
	*/
	class Node: private tl_cpputils::NonCopyable {
		friend class RecursiveCFGBuilder;
		friend class NonRecursiveCFGBuilder;
	public:
		Node();
	...
	* Instances of this class have reference object semantics.
	*/
	class Edge: private tl_cpputils::NonCopyable {
		friend class RecursiveCFGBuilder;
		friend class NonRecursiveCFGBuilder;
	public:
