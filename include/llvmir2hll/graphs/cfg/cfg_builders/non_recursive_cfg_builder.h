/**
* @file include/llvmir2hll/graphs/cfg/cfg_builders/non_recursive_cfg_builder.h
* @brief A non-recursive creator of control-flow graphs (CFGs) from functions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CFG_CFG_BUILDERS_NON_RECURSIVE_CFG_BUILDER_H
#define LLVMIR2HLL_GRAPHS_CFG_CFG_BUILDERS_NON_RECURSIVE_CFG_BUILDER_H
...
#include "llvmir2hll/support/visitor_adapter.h"
