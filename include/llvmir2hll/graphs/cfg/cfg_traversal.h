/**
* @file include/llvmir2hll/graphs/cfg/cfg_traversal.h
* @brief A base class of all CFG traversals.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CFG_CFG_TRAVERSAL_H
#define LLVMIR2HLL_GRAPHS_CFG_CFG_TRAVERSAL_H
...
*/
class CFGTraversal: private tl_cpputils::NonCopyable {
protected:
