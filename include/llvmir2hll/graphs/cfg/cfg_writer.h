/**
* @file include/llvmir2hll/graphs/cfg/cfg_writer.h
* @brief A base class of all control-flow graph (CFG) writers.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CFG_CFG_WRITER_H
#define LLVMIR2HLL_GRAPHS_CFG_CFG_WRITER_H
...
*/
class CFGWriter: private tl_cpputils::NonCopyable {
public:
	virtual ~CFGWriter() = 0;
