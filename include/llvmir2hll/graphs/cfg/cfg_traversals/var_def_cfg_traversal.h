/**
* @file include/llvmir2hll/graphs/cfg/cfg_traversals/var_def_cfg_traversal.h
* @brief A CFG traversal that checks whether a variable is defined/modified
*        between two statements.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_GRAPHS_CFG_CFG_TRAVERSALS_VAR_DEF_CFG_TRAVERSAL_H
#define LLVMIR2HLL_GRAPHS_CFG_CFG_TRAVERSALS_VAR_DEF_CFG_TRAVERSAL_H
