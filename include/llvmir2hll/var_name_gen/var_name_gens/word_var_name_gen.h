/**
* @file include/llvmir2hll/var_name_gen/var_name_gens/word_var_name_gen.h
* @brief A generator of English words as variable names.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_VAR_NAME_GEN_VAR_NAME_GENS_WORD_VAR_NAME_GEN_H
#define LLVMIR2HLL_VAR_NAME_GEN_VAR_NAME_GENS_WORD_VAR_NAME_GEN_H
