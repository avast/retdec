/**
* @file include/llvmir2hll/var_renamer/var_renamers/readable_var_renamer.h
* @brief A renamer of variable names which names them to make the code as
*        readable as possible.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_READABLE_VAR_RENAMER_H
#define LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_READABLE_VAR_RENAMER_H
