/**
* @file include/llvmir2hll/var_renamer/var_renamers/address_var_renamer.h
* @brief A renamer of variable names which extracts and uses the original
*        addresses of the variables.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_ADDRESS_VAR_RENAMER_H
#define LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_ADDRESS_VAR_RENAMER_H
