/**
* @file include/llvmir2hll/var_renamer/var_renamers/hungarian_var_renamer.h
* @brief A renamer of variable names by using the Hungarian notation.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_HUNGARIAN_VAR_RENAMER_H
#define LLVMIR2HLL_VAR_RENAMER_VAR_RENAMERS_HUNGARIAN_VAR_RENAMER_H
