/**
* @file include/llvmir2hll/support/value_text_repr_visitor.h
* @brief A visitor for obtaining a textual representation of a value.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_SUPPORT_VALUE_TEXT_REPR_VISITOR_H
#define LLVMIR2HLL_SUPPORT_VALUE_TEXT_REPR_VISITOR_H
