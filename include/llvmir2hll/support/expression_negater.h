/**
* @file include/llvmir2hll/support/expression_negater.h
* @brief Negation of expressions.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_SUPPORT_EXPRESSION_NEGATER_H
#define LLVMIR2HLL_SUPPORT_EXPRESSION_NEGATER_H
...
*/
class ExpressionNegater: private Visitor, private tl_cpputils::NonCopyable {
public:
