/**
* @file include/llvmir2hll/support/visitors/ordered_all_visitor.h
* @brief A visitor that visits everything in an ordered way.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_SUPPORT_VISITORS_ORDERED_ALL_VISITOR_H
#define LLVMIR2HLL_SUPPORT_VISITORS_ORDERED_ALL_VISITOR_H
