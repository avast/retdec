/**
* @file include/llvmir2hll/support/funcs_with_prefix_remover.h
* @brief Removes functions whose name starts with a prefix from the given set.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_SUPPORT_FUNCS_WITH_PREFIX_REMOVER_H
#define LLVMIR2HLL_SUPPORT_FUNCS_WITH_PREFIX_REMOVER_H
