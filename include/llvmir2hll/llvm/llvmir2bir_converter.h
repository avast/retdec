/**
* @file include/llvmir2hll/llvm/llvmir2bir_converter.h
* @brief A base class for all converters of LLVM IR to BIR.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_LLVM_LLVMIR2BIR_CONVERTER_H
#define LLVMIR2HLL_LLVM_LLVMIR2BIR_CONVERTER_H
...
*/
class LLVMIR2BIRConverter: private tl_cpputils::NonCopyable {
public:
