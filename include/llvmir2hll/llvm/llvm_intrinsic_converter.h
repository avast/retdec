/**
* @file include/llvmir2hll/llvm/llvm_intrinsic_converter.h
* @brief Conversion of LLVM intrinsic functions into functions from the
*        standard C library.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_LLVM_LLVM_INTRINSIC_CONVERTER_H
#define LLVMIR2HLL_LLVM_LLVM_INTRINSIC_CONVERTER_H
