/**
* @file include/llvmir2hll/llvm/llvmir2bir_converters/orig_llvmir2bir_converter/llvm_branch_info.h
* @brief Supportive information about LLVM branches and loops.
* @copyright (c) 2017 Avast Software, licensed under the MIT license
*/

#ifndef LLVMIR2HLL_LLVM_LLVMIR2BIR_CONVERTERS_ORIG_LLVMIR2BIR_CONVERTER_LLVM_BRANCH_INFO_H
#define LLVMIR2HLL_LLVM_LLVMIR2BIR_CONVERTERS_ORIG_LLVMIR2BIR_CONVERTER_LLVM_BRANCH_INFO_H
...
*/
class LLVMBranchInfo final: private tl_cpputils::NonCopyable {
public:
