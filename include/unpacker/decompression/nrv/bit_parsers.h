/**
 * @file include/unpacker/decompression/nrv/bit_parsers.h
 * @brief Bit getters for NRV decompression algorithms.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef UNPACKER_DECOMPRESSION_NRV_BIT_PARSERS_H
#define UNPACKER_DECOMPRESSION_NRV_BIT_PARSERS_H
...
public:
	...
	virtual bool getBit(uint8_t& bit, const DynamicBuffer& data, uint32_t& pos) override
	{
		...
		if ((_value & 0xFF) == 0)
		{
			...
			_value = data.read<uint8_t>(pos++, tl_cpputils::Endianness::LITTLE);
...
public:
	...
	virtual bool getBit(uint8_t& bit, const DynamicBuffer& data, uint32_t& pos) override
	{
		...
		if (_value == 0)
		{
			...
			_value = data.read<uint32_t>(pos, tl_cpputils::Endianness::LITTLE);
			pos += 4;
