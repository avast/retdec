/**
 * @file include/ar-extractor/archive_wrapper.h
 * @brief Definition of ArchiveWrapper class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef AR_EXTRACTOR_ARCHIVE_WRAPPER_H
#define AR_EXTRACTOR_ARCHIVE_WRAPPER_H
 ...
 */
class ArchiveWrapper : private tl_cpputils::NonCopyable
{
	public:
