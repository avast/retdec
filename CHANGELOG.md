...
* New Feature: Added presentation of version info from PE file in `retdec-fileinfo` ([#408](https://github.com/avast-tl/retdec/issues/408), [#519](https://github.com/avast-tl/retdec/pull/519)).
