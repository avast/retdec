...
#define DEM_EQ(mangled, demangled) EXPECT_EQ(demangled, demangler->demangleToString(mangled));
...
TEST_F(LlvmMicrosoftDemanglerTests, DemangleCppClassNames)
{
...
TEST_F(LlvmMicrosoftDemanglerTests, DoNotDemangleCppClassNamesWhenTheyDoNotMatchRegex)
{
...
TEST_F(LlvmMicrosoftDemanglerTests, RandomTests)
{
	DEM_EQ("??D@YAPAXI@Z",
...
//	       "virtual void * __thiscall cGram::`vbase dtor'(unsigned int)"
	...
	DEM_EQ("??1?$_Vector_iterator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QAE@XZ",
		   "__thiscall std::_Vector_iterator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>::~_Vector_iterator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>(void)");
	...
	DEM_EQ("?begin@?$vector@Urule_t@cGram@@V?$allocator@Urule_t@cGram@@@std@@@std@@QAE?AV?$_Vector_iterator@Urule_t@cGram@@V?$allocator@Urule_t@cGram@@@std@@@2@XZ",
		   "class std::_Vector_iterator<struct cGram::rule_t, class std::allocator<struct cGram::rule_t>> __thiscall std::vector<struct cGram::rule_t, class std::allocator<struct cGram::rule_t>>::begin(void)");
