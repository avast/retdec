...
GlobalVariablesGetCorrectlyRenamed) {
	...
	// }
	//
	Variable* varA(Variable::create("a_804839f1", IntType::create(32)));
	module->addGlobalVar(varA);
	Variable* varB(Variable::create("b_7f375bc2", IntType::create(32)));
...
ParametersOfFunctionDefinitionGetCorrectlyRenamed) {
	...
	Variable* varB(Variable::create("b_5f335bd2", IntType::create(32)));
...
FunctionLocalVariablesGetCorrectlyRenamed) {
	...
	// }
	//
	Variable* varA(Variable::create("res0_cd53f89", IntType::create(32)));
