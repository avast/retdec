...
ARCHIVE_DECOMPILER_PY = INSTALL_BIN_DIR + '/retdec_archive_decompiler.py'
SIG_FROM_LIB_PY = INSTALL_BIN_DIR + '/retdec_signature_from_library_creator.py'
UNPACK_PY = INSTALL_BIN_DIR + '/retdec_unpacker.py'
