...
{
	private:
		std::shared_ptr<fileformat::IntelHexFormat> ihexParser; ///< file parser
	...
	public:
		IntelHexDetector(std::string pathToInputFile, FileInformation &finfo, cpdetect::DetectParams &searchPar, fileformat::LoadFlags loadFlags);
