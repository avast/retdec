/**
 * @file src/fileinfo/file_presentation/getters/iterative_getter/iterative_distribution_getter/anomalies_plain_getter.h
 * @brief Definition of AnomaliesPlainGetter class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEINFO_FILE_PRESENTATION_GETTERS_ITERATIVE_GETTER_ITERATIVE_DISTRIBUTION_GETTER_ANOMALIES_PLAIN_GETTER_H
#define FILEINFO_FILE_PRESENTATION_GETTERS_ITERATIVE_GETTER_ITERATIVE_DISTRIBUTION_GETTER_ANOMALIES_PLAIN_GETTER_H
 ...
 */
class AnomaliesPlainGetter : public IterativeDistributionGetter
{
	protected:
	...
	public:
		...
		virtual ~AnomaliesPlainGetter() override;
