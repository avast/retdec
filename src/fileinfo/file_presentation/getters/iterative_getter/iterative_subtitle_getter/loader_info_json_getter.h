 ...
 * @brief Declaration of LoaderInfoJsonGetter class.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

#ifndef FILEINFO_FILE_PRESENTATION_GETTERS_ITERATIVE_GETTER_ITERATIVE_SUBTITLE_GETTER_LOADER_INFO_JSON_GETTER_H
#define FILEINFO_FILE_PRESENTATION_GETTERS_ITERATIVE_GETTER_ITERATIVE_SUBTITLE_GETTER_LOADER_INFO_JSON_GETTER_H
 ...
 */
class LoaderInfoJsonGetter : public IterativeSubtitleGetter
{
	public:
		LoaderInfoJsonGetter(FileInformation &fileInfo);
		virtual ~LoaderInfoJsonGetter() override;
