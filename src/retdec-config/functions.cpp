/**
 * @file src/retdec-config/functions.cpp
...
using tl_cpputils::likeConstVersion;
...
void Function::setStartLine(const tl_cpputils::Address& l)       { _startLine = l; }
void Function::setEndLine(const tl_cpputils::Address& l)         { _endLine = l; }
 ...
 * @return Pointer to function or @c nullptr if not found.
 */
Function* FunctionContainer::getFunctionByStartAddress(const tl_cpputils::Address& addr)
{
	for (auto& elem : _data)
	{
