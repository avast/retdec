/**
 * @file src/retdec-config/vtables.cpp
...
VtableItem::VtableItem(const tl_cpputils::Address& a) :
		_address(a)
{
...
void VtableItem::setTargetFunctionAddress(const tl_cpputils::Address& a)
{
	_targetAddress = a;
}
...
tl_cpputils::Address VtableItem::getId() const
{
	return getAddress();
}
 ...
 */
tl_cpputils::Address VtableItem::getAddress() const
{
	return _address;
}
 ...
 */
tl_cpputils::Address VtableItem::getTargetFunctionAddress() const
{
...
Vtable::Vtable(const tl_cpputils::Address& a)
{
	_address = a;
}
...
tl_cpputils::Address Vtable::getId() const
{
	return getAddress();
}
 ...
 */
tl_cpputils::Address Vtable::getAddress() const
{
	return _address;
}
