/**
 * @file src/retdec-config/tool_info.cpp
...
{
	return tl_cpputils::containsCaseInsensitive(_name, n)
			|| tl_cpputils::containsCaseInsensitive(_version, n);
}
...
{
	return tl_cpputils::containsCaseInsensitive(_version, v);
}
