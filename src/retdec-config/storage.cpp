/**
 * @file src/retdec-config/storage.cpp
...
Storage Storage::inMemory(const tl_cpputils::Address& address)
{
 ...
 */
bool Storage::isMemory(tl_cpputils::Address& globalAddress) const
{
 ...
 */
tl_cpputils::Address Storage::getAddress() const
{
 ...
 */
tl_cpputils::Maybe<unsigned> Storage::getRegisterNumber() const
{
