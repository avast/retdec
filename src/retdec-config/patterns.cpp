/**
 * @file src/retdec-config/patterns.cpp
...
void Pattern::Match::setOffset(const tl_cpputils::Address& offset)
{
	_offset = offset;
}

void Pattern::Match::setAddress(const tl_cpputils::Address& address)
{
	_address = address;
}
...
tl_cpputils::Address Pattern::Match::getOffset() const
{
	return _offset;
}

tl_cpputils::Address Pattern::Match::getAddress() const
{
	return _address;
}

tl_cpputils::Maybe<unsigned> Pattern::Match::getSize() const
{
	return _size;
}

tl_cpputils::Maybe<unsigned> Pattern::Match::getEntrySize() const
{
	return _entrySize;
}
