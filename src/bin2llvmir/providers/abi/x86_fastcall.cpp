...
AbiX86Fastcall::AbiX86Fastcall(llvm::Module* m, Config* c) :
		Abi(m, c)
{
...
AbiX86Fastcall::~AbiX86Fastcall()
{

}

bool AbiX86Fastcall::isGeneralPurposeRegister(const llvm::Value* val)
{
...
bool AbiX86Fastcall::isNopInstruction(cs_insn* insn)
{
