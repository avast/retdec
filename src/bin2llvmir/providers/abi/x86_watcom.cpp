...
AbiX86Watcom::AbiX86Watcom(llvm::Module* m, Config* c) :
		Abi(m, c)
{
...
AbiX86Watcom::~AbiX86Watcom()
{

}

bool AbiX86Watcom::isGeneralPurposeRegister(const llvm::Value* val)
{
...
bool AbiX86Watcom::isNopInstruction(cs_insn* insn)
{
