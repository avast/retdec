...
AbiX86Pascal::AbiX86Pascal(llvm::Module* m, Config* c) :
		Abi(m, c)
{
...
AbiX86Pascal::~AbiX86Pascal()
{

}

bool AbiX86Pascal::isGeneralPurposeRegister(const llvm::Value* val)
{
...
bool AbiX86Pascal::isNopInstruction(cs_insn* insn)
{
