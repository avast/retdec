/**
 * @file src/cpdetect/signatures/yara/database/mips/elf/compiler.cpp
 * @brief Database of signatures.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

const char *mipsElfCompiler =
R"mips_elf_comp(rule rule_1_android_ndk_r8
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_3_GCC__mips_linux_gcc
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_4_GCC__pic32_linux_gcc
{
	meta:
		tool = "C"
		name = "XC32 GCC"
...
rule rule_6_LLVM__llvm_mips_elf
{
	meta:
		tool = "C"
		name = "LLVM"
