/**
 * @file src/cpdetect/signatures/yara/database/powerpc/macho/compiler.cpp
 * @brief Database of signatures.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

const char *powerpcMachOCompiler =
R"ppc_macho_packer(
rule XCode_SDK_ppc_1 {
	meta:
		tool = "C"
		name = "XCode"
