/**
 * @file src/cpdetect/signatures/yara/database/arm/pe/compiler.cpp
 * @brief Database of signatures.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

const char *armPeCompiler =
R"arm_pe_compiler(rule rule_1_GCC__arm_mingw32ce_gcc
{
	meta:
		tool = "C"
		name = "MinGW GCC"
...
rule rule_5_Windows_Mobile_Visual_C
{
	meta:
		tool = "C"
		name = "MSVC"
...
rule rule_6_Windows_Mobile_Visual_C
{
	meta:
		tool = "C"
		name = "MSVC"
