/**
 * @file src/cpdetect/signatures/yara/database/arm/elf/compiler.cpp
 * @brief Database of signatures.
 * @copyright (c) 2017 Avast Software, licensed under the MIT license
 */

const char *armElfCompiler =
R"arm_elf_compiler(rule rule_1_android_ndk_r8
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_5_GCC__arm_gp2x_linux_gcc
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_6_GCC__arm_thumb_elf_gcc
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_7_GCC__arm_thumb_elf_gcc
{
	meta:
		tool = "C"
		name = "GCC"
...
rule rule_8_Texas_Instruments_C_C___Compiler__TMS470
{
	meta:
		tool = "C"
