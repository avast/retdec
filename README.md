...
* Windows:
  ...
  * export PATH=$PATH:"/c/Program Files (x86)/Windows Kits/10/bin/10.0.16299.0/x64"
  * export PATH=$PATH:"/c/Program Files (x86)/Microsoft Visual Studio/2017/Community/MSBuild/15.0/Bin"
  * `cmake .. -DCMAKE_INSTALL_PREFIX=<path> -G<generator>` (make sure to use forward slash in path, for example, c:/retdec)
