...
```sh
sudo apt-get install build-essential cmake git perl python3 bash coreutils wget bc graphviz upx flex bison zlib1g-dev libtinfo-dev autoconf pkg-config m4 libtool
```
